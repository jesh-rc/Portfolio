        ...
        >
          <div className="container mx-auto">
            ...
            >
              ...
              {/* content */}
              <div className="min-h-[70vh] flex-1 relative">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* experience */}
                    {tab === "experience" && (
                      <TabsContent value="experience" className="w-full" forceMount>
                    ...
                    {/* education */}
                    {tab === "education" && (
                      <TabsContent value="education" className="w-full" forceMount>
                        <div className='flex flex-col gap-[30px] text-center xl:text-left'>
                    ...
                    {/* skills */}
                    {tab === "skills" && (
                      <TabsContent value="skills" className="w-full" forceMount>
                        <div className='flex flex-col gap-[30px] text-center xl:text-left'>
                    ...
                    {/* about me */}
                    {tab === "about" && (
                      <TabsContent value="about" className="w-full text-center xl:text-left" forceMount>
